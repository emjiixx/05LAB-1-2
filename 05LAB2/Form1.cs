...
namespace RegistrationTextFile
{
    public partial class frmRegistration : Form
    {
        ...
        public string FileName(string fileName)
        {
            ...
            {
                throw new FileNameException("Error: File name/Student Number's file name already existed or null. Please try again.");
            }
            return fileName;
        }
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                long getStudentNumber = long.Parse(txtStudentNo.Text);
                ...
                {
                    string studentInfo = $"Student No.: {getStudentNumber} \nFull Name: {getFullName} \nProgram: {getProgram} \n" +
